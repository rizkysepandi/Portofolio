<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #3C4B64">
    ...
    <div class="sidebar" >
        ...
        <div class="mt-3 pb-3 d-flex">
            <div>
            <a href="/dashboard"><img src="<?php echo e(asset('BUMDES/assets/logo/logo-siabdes.png')); ?>" class=" elevation-2" width="200px" height="60px" alt="SIABDES Logo"></a>
            </div>
        </div>
        <div class="pb-3 mb-3 d-flex">
            <div>
            <a href="/dashboard"><img src="<?php echo e(asset('BUMDES/assets/logo/logo-btp-png.png')); ?>" class="elevation-2" width="200px" height="60px" alt="BTP Logo"></a>
            </div>
        </div>
...
<?php /**PATH C:\Users\Rizky.SHS\Documents\GitHub\Bumdes\resources\views/bumdes/dashboard/layouts/sidebar.blade.php ENDPATH**/ ?>