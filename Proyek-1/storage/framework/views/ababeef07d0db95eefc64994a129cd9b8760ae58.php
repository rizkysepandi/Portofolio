...
<body style="background-color: #D9D9D9" class="hold-transition sidebar-mini">
    <div class="wrapper">
        <?php echo $__env->make('bumdes.dashboard_admin.layouts.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    
        <?php echo $__env->make('bumdes.dashboard_admin.layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\Users\Rizky.SHS\Documents\GitHub\Bumdes\resources\views/bumdes/dashboard_admin/layouts/main.blade.php ENDPATH**/ ?>