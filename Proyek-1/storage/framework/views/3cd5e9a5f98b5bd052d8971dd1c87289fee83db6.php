                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex mb-3" >
                                <div class="ms-auto">
                                    <?php echo $__env->make('bumdes.dashboard.jurnal_khusus.pengeluaran_kas.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </div>
                            </div>
                                    ...
                                    <p style="visibility: hidden; height: 0px;"> 
                                        ...
                                        <?php $__currentLoopData = $jurnals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jurnal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/pengeluaran_kas/<?php echo e($data->id); ?>/edit" class="nav-icon fas fa-edit"></a>
                                                    
                                                    <form action="/pengeluaran_kas/<?php echo e($jurnal->id); ?>/delete" method="POST" class="d-inline">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('bumdes.dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Rizky.SHS\Documents\GitHub\Bumdes\resources\views/bumdes/dashboard/jurnal_khusus/pengeluaran_kas/index.blade.php ENDPATH**/ ?>